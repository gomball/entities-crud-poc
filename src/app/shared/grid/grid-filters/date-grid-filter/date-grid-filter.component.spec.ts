...
import { DatepickerComponent } from '../../../controls/components/datepicker/datepicker.component';
...
import { DateGridFilterComponent } from './date-grid-filter.component';
...
class StubComponent {
  ...
  gridOptions: AgGridOptions = {
    columnDefs: [
      ...
      { headerName: 'test_field_header', field: 'testField', filterFramework: DateGridFilterComponent }
  ...
  data = [
    { id: 1, testField: Date.today().addDays(-1) },
    { id: 2, testField: Date.today().addDays(0) },
    { id: 3, testField: Date.today().addDays(1) }
  ];
}

describe('DateGridFilterComponent', () => {
  let fixture: ComponentFixture<StubComponent>;
  let stub: StubComponent;
  let component: DateGridFilterComponent;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [AgGridModule.withComponents([DateGridFilterComponent]), FormsModule, NgbDatepickerModule, NgxTranslateStubModule],
      declarations: [DateGridFilterComponent, StubComponent, DatepickerComponent, SelectComponent, ControlLayoutDirective, ShowDirective],
