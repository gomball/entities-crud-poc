...
import { TextGridFilterComponent } from './text-grid-filter.component';
...
class StubComponent {
  ...
  gridOptions: AgGridOptions = {
    columnDefs: [
      ...
      { headerName: 'test_field_header', field: 'testField', filterFramework: TextGridFilterComponent }
...
describe('TextGridFilterComponent', () => {
  let fixture: ComponentFixture<StubComponent>;
  let stub: StubComponent;
  let component: TextGridFilterComponent;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [AgGridModule.withComponents([TextGridFilterComponent]), FormsModule, NgxTranslateStubModule],
      declarations: [TextGridFilterComponent, StubComponent, InputComponent, SelectComponent, ControlLayoutDirective],
